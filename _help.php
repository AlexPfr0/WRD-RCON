...
<html>
    <head>
        ...
        Vous aurez beaucoup plus d'effets "graphiques" en utlisant Firefox. Sur Chrome, les images dans les listes déroulantes ne s'affiche pas,
         les cartes ne s'affichent pas dans leur emplacement lors du passage sur leur nom dan la liste
<!--        <p><a class="link" href="./">J'ai compris et je ne veux plus voir ce message ! (tu seras malgré tout renotifié dans 30 jours :))
                En cliquant sur ce lien, je règle automatiquement les premiers paramètres et ensuite j'accède au site.</a> </p>-->
                ...
                <p><a class="link" href="./index.php">Retour à la page des paramètres</a></p></body>
</html>
